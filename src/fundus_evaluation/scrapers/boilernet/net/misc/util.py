...
# everything that is a child of one of these tags is considered boilerplate and hence ignored by the classifier
TAGS_TO_IGNORE = {"head", "iframe", "script", "meta", "link", "style", "input", "checkbox", "button", "noscript"}
